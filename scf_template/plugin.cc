...
namespace psi{ namespace scf_template {

extern "C"
int read_options(std::string name, Options &options)
{
    if (name == "SCF_TEMPLATE"|| options.read_globals()) {
...
extern "C"
SharedWavefunction scf_template(SharedWavefunction ref_wfn, Options &options)
{
